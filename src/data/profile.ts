...
export const profile: Profile = {
  ...
  highlights: [
    ...
    'Blog writer on NestJS, Linux, Docker, and terminal workflows',
  ],
  interests: [
    'TypeScript',
    'NestJS',
  ...
  philosophy:
    'Crafting elegant solutions starts with curiosity and ends with code that is robust, performant, and maintainable. I care about the details — clean APIs, predictable behavior, and tooling that gets out of your way.',
  careerHighlights: [
    'Senior full-stack developer at Takeo.ai, writing modern, performant code for client and internal projects',
    'Full-stack JS developer at EB Pearls — authentication, data integration, and Node.js services',
    'Built distributed apps on Ethereum with Solidity and Web3.js',
    'Shipped PHP/WordPress sites and a restaurant-management app with Android',
  ],
}
