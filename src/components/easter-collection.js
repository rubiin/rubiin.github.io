...
function ghost() {
  ...
  var ghost = function () {
    ...
    if (typeof document !== null) document.body.appendChild(img);
  ...
  var init = function (data) {
    if (typeof document !== null) document.addEventListener("keyup", record);
  };
...
function britney() {
  ...
  var britney = function () {
    if (typeof document !== null) var shock = document.createElement("div");
    var img = new Image();
    img.src = data;
    img.style.width = "250px";
...
function linux() {
  ...
  var data =
    "https://creditcontinue.coventry.domains/beasties/wp-content/uploads/2018/11/producticve-penguins.gif";
...
function ufo() {
  ...
  var data =
    "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/8e5f6449-b1a2-4d3f-bd20-6c218597a4c8/d2ze6ud-e55af640-2b07-4b13-87de-a8ba10c89b21.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..iqEG7hlVaT9YhC_I13-8kCa5Lmlw-m4TMiDjZan6bYo";
