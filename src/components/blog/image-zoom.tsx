...
export function ImageZoom({
  ...
  // AVIF sibling for local images (generated by scripts/optimize-images.mjs);
  // the lightbox keeps the full-size WebP. Remote URLs render as plain img.
  const avifSrc =
    src.startsWith('/') && /\.(webp|png|jpe?g)$/i.test(src)
      ? src.replace(/\.(webp|png|jpe?g)$/i, '.avif')
      : null
