...
published: true
description: 
tags: nestjs,typescript,nodejs,backend
cover_image: https://miro.medium.com/max/1920/1*LsHTe083IpvKL5anH7b_NA.png
---
...
- Boilerplate
  ...
  - [NestJS Starter Reactjs](https://github.com/Fast-Modular-Project/starter-reactjs-nestjs-mysql) - Start your next fullstack web app in seconds.A clean and scalable architecture with AWS deployment and continuous integration
...
- Utilities
 ...
 - [Nest CQRS](https://github.com/nestjs/cqrs) - A lightweight CQRS module for Nest framework.
  ...
  - [Nestjs Easy Config](https://github.com/rubiin/nestjs-easyconfig) - A simple module to handle configurations for nestjs prokects with awesome features.
  ...
  - [NestJs Snippets for vscode](https://marketplace.visualstudio.com/items?itemName=rubiin.nestjs) - Adds common snippets for nestjs projects
  - [Nest RBAC](https://github.com/nestjs/cqrs) - The rbac module for Nest.
 ...
 - [Nest stripe](https://www.npmjs.com/package/nestjs-stripe) -Injectable Stripe client for your nestjs projects
 - [Nestjs Admin](https://www.npmjs.com/package/nestjs-admin) - Ready-to-use user interface for administrative activities. Allows to list, edit, create, delete entities.
 - [Nestjs Redirect](https://www.npmjs.com/package/@nestjsplus/redirect) - 
Decorator for handling Redirects with NestJS
 - [Nestjs Cookies](https://www.npmjs.com/package/@nestjsplus/cookies) - 
Decorator for handling Cookies with NestJS
- State Management
